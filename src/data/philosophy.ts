...
export const treatmentPhilosophy: PhilosophyItem[] = [

  {
    ...
    icon: "bookOpenCheck",
    description:
      "انتخاب روش‌های درمانی بر اساس جدیدترین شواهد علمی، راهنماهای معتبر پزشکی و شرایط بالینی هر بیمار انجام می‌شود."
  },

  {
    title: "تصمیم‌گیری مشترک با بیمار",
    icon: "userCheck",
    description:
...

  {
    ...
    icon: "messageCircle",
    description:
      "توضیح روشن گزینه‌های درمانی و پاسخ‌گویی به پرسش‌های بیمار و خانواده، بخش مهمی از مسیر درمان است."
  },
